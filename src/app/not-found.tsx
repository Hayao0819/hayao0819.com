        ...
        <>
            <Layout>
                <PageShell>
                    ...
                    <h1 className="mt-4 font-body-prose text-3xl leading-tight tracking-tight md:text-4xl">404 Page Not Found</h1>
                    <p className="mt-6 text-[13px] text-foreground/70">内容が無いようです。</p>
