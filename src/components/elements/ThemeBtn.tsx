...
export function ThemeSwitch() {
    ...
    return (
        <div className="daisy-form-control">
            <label className="daisy-label cursor-pointer" onChange={() => toggleTheme}>
                {/*<span className="daisy-label-text">Remember me</span>*/}

                {mounted && (
                    <>
                        {theme === "dark" ? (
                            <input type="checkbox" className="daisy-toggle" checked />
                        ) : (
                            <input type="checkbox" className="daisy-toggle" />
                        )}
                    </>
                )}
            </label>
